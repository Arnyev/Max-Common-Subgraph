...
namespace Taio
{
    ...
    {
        private static uint ExpectedSize;
        ...
        private static List<(uint, uint)> maxMappingEdge;
        private static uint bestEdgeCount;
        private static uint bestFutureWorth;
        private static bool[,] _graphG;
        private static bool[,] _graphH;

        public static List<(uint, uint)> Find(bool[,] graphG, bool[,] graphH, uint stepSize)
        {
            ...
            maxMappingEdge = new List<(uint, uint)>();
